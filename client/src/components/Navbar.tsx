...
function Navbar() {
    return (
        ...
        >
            <div className="h-full flex justify-between items-center w-full py-3 px-8 bg-primary-700 text-white">
                {/* Begin::Logo */}
                ...
                <p className="text-primary-200 hidden md:block">
                    Discover your perfect rental apartments with out advance search
                </p>
                {/* End::SearchText */}
